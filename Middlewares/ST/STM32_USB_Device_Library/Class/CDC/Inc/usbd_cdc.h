...
#define CDC_IN_EP2                                   0x82U  /* EP1 for data IN */
#define CDC_OUT_EP2                                  0x02U  /* EP1 for data OUT */
...
typedef struct _USBD_CDC_Itf
{
  ...
  int8_t (* Receive)(uint8_t epnum, uint8_t *Buf, uint32_t *Len);
...
typedef struct
{
  ...
  __IO uint32_t TxState[2];
  __IO uint32_t RxState[2];
